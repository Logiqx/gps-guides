...
Lightwind windfoil session in easterly winds. Portland Harbour, UK.
...
Focused on analysis of 500m runs:

- 500m #4 is terrible quality data from the APEX Pro
  - Massive spikes in positional data
